...
namespace Hog::Math {
	...
	const glm::vec3 Vector3::Zero = { 0.f, 0.f, 0.f };
	const glm::vec3 Vector3::One = { 1.f, 1.f, 1.f };
	const glm::vec3 Vector3::UnitX = { 1.f, 0.f, 0.f };
	const glm::vec3 Vector3::UnitY = { 0.f, 1.f, 0.f };
	const glm::vec3 Vector3::UnitZ = { 0.f, 0.f, 1.f };
