...
namespace Hog
{
	BufferDescription::BufferDescription(Defaults option)
	{
		...
		case Defaults::ShaderBindingTable:
		{
			MemoryUsage = VMA_MEMORY_USAGE_AUTO;
			AllocationCreateFlags = VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT |
				VMA_ALLOCATION_CREATE_MAPPED_BIT | VMA_ALLOCATION_CREATE_HOST_ACCESS_RANDOM_BIT;

			BufferUsageFlags = VK_BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT;
		}break;
		}
	}
	...
	ImageDescription::ImageDescription(Defaults options)
	{
		switch (options)
		{
			...
			case Defaults::SampledHDRColorAttachment:
			{
				ImageUsageFlags = VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_SAMPLED_BIT;
				ImageAspectFlags = VK_IMAGE_ASPECT_COLOR_BIT;
